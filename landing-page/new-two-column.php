...
<div class="ibox float-e-margins">
	<div class="ibox-content">
		<h3 class="text-24 text-light">Add New <b>2-Column</b> Row</h3>
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group margin-top-20">
					<label class="text-14">Left Column Content <span class="text-red text-12 text-italic">Note to Alex: this is meant to be a WYSIWYG Editor</span></label>
					<textarea class="form-control" placeholder="Content" rows="10"></textarea>
				</div>
				<div class="form-group margin-top-20">
					<label class="text-14">Right Column Content <span class="text-red text-12 text-italic">Note to Alex: this is meant to be a WYSIWYG Editor</span></label>
					<textarea class="form-control" placeholder="Content" rows="10"></textarea>
				</div>
			...
			<div class="col-md-4 col-md-offset-1 lp-additional-settings">
				...
				<div class="form-group margin-top-20">
					<label class="text-12 text-light">Column Width Division</label>
					<select class="form-control">
						<option value="">50% Left - 50% Right</option>
						<option value="">40% Left - 60% Right</option>
						<option value="">60% Left - 40% Right</option>
					</select>
				</div>
				<div class="form-group margin-top-20">
