				...
				<div class="container">
					<div class="row">
						<div class="col-md-10 col-md-offset-1 text-center">
							<img src="img/silent-selling-logo.png" id="lpLogo" class="img-responsive image-align-center" />
						</div>
					</div>
					<div class="row">
			...
			<div id="footer">
				<div class="container">
					...
					<div class="row copyright">
						<div class="col-md-12 text-center">
							<p>Copyright &copy; 2016 &nbsp; <a href="#">Company Name</a></p>
						</div>
					</div>
